...
void PointLight::AddLight(const Game& game, const Microsoft::WRL::ComPtr<ID3D11Device>& pDevice, const DirectX::XMVECTOR& position, 
	...
	m_lightBuffer.intensity[m_lightBuffer.counter] = DirectX::XMFLOAT4(1.0f, 0.0f, 0.0f, 0.0f);
